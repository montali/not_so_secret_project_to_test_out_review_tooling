...
# I now add a comment here. 
# Comment's still here!
# Now, I can also do a change here, and ask graphite to absorb it into the right PR in the stack
# (i.e. the PR that created this file, without checking it out)
